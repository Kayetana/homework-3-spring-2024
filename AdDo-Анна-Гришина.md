...
6. [Мероприятия](#мероприятия)
7. [Кейсы](#кейсы)
8. [Форум идей](#форум-идей)
9. [Монетизация](#монетизация)
10. [Справка](#справка)
11. [Страница авторизации](#страница-авторизации)
12. [Регистрация кабинета](#регистрация-кабинета)
13. [Кабинет](#кабинет)
14. [Кампании](#кампании)
15. [Аудитории](#аудитории)
16. [Бюджет](#бюджет)
17. [Центр коммерции](#центр-коммерции)
18. [Лид-формы](#лид-формы)
...
- Новости. При нажатии на кнопку "Подробнее" открывается страница новости https://ads.vk.com/news/{str:title}

![news2](images/news2.png)

- Новости. При нажатии на блок новости открывается страница этой новости https://ads.vk.com/news/{str:title}
...
- Полезные материалы. При нажатии на кнопку "Подробнее" открывается страница материала https://ads.vk.com/insights/{str:title}

![materials2](images/materials2.png)

- Полезные материалы. При нажатии на блок материала открывается страница этого материала
...
- Кейсы. При нажатии на кнопку "Подробнее" открывается страница кейса https://ads.vk.com/cases/{str:title}
...
- Кабинет. Левая панель. При нажатии на кнопку "Кампании" открывается страница [Кампании](#кампании)
- Кабинет. Левая панель. При нажатии на кнопку "Аудитории" открывается страница [Аудитории](#аудитории)
- Кабинет. Левая панель. При нажатии на кнопку "Бюджет" открывается страница [Бюджет](#бюджет)
- Кабинет. Левая панель. При нажатии на кнопку "Центр коммерции" открывается страница [Центр коммерции](#центр-коммерции)
- Кабинет. Левая панель. При нажатии на кнопку "Лид-формы" открывается страница [Лид-формы](#лид-формы)
- Кабинет. Левая панель. При нажатии на кнопку "Настройки" открывается страница [Настройки](#настройки)
...
- Лид-формы. При нажатии на кнопку "Создать лид-форму" появляется всплывающее окно "Новая лид-форма"

![form_creation](images/form_creation.png)

- Лид-формы. Ошибка "Превышена максимальная длина поля" при вводе в поле "Название компании"
строки больше 30 символов
