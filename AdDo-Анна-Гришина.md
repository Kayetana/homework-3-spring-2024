...
- Аудитории. При нажатии на кнопку "Создать аудиторию" открывается модальное окно "Создание аудитории"
...
- Аудитории. В счетчике символов корректно отображается длина названия в символах
- Аудитории. При нажатии на кнопку "Добавить источник" открывается модальное окно "Включить источник"
...
- Настройки. Общие. При нажатии кнопки "Отменить" все изменения сбрасываются
- Настройки. Общие. При корректном заполнении полей и нажатии кнопки "Сохранить" все изменения сохраняются
...
- Настройки. Уведомления. При нажатии кнопки "Отменить" все изменения сбрасываются
- Настройки. Уведомления. При нажатии кнопки "Сохранить" все изменения сохраняются
